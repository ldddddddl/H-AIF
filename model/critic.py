...
class Critic(nn.Module):
    def __init__(self, out_channels=9, dropout=0.1, config=None, *args, **kwargs) -> None:
        ...
        if config.olny_action_generate:
            ...
            self.grip_conv_2 = nn.Conv2d(20, 20, kernel_size=10, stride=7, padding=1, bias=True)
            self.side_conv_1 = nn.Conv2d(20, 20, kernel_size=7, stride=5, padding=1, bias=True)
            self.side_conv_2 = nn.Conv2d(20, 20, kernel_size=7, stride=5, padding=1, bias=True)
